--If you want to spam my webhook your just gonna get your ip taken luauth winning
...
local Window=Library:Window(name,Color3.fromRGB(255,0,0),700,Color3.new(255,0,0/255),600)
local CombatTab=Window:Tab("Combat")
local CombatTabMainSection=CombatTab:Section("Aimbot")

CombatTabMainSection:Toggle("Kill All(Fastest)",function(state)
    if state then
...
CombatTabMainSection:Toggle("Ignore FOV",function(x)
    ArsoniaTable.Aimbot.Silentaim.Ignorefov=x
end)
CombatTabMainSection:Dropdown("Triggerbot",{"None","Force Fire","Fake Click","Mouse"},function(x)
...
CombatTabGunmodsSection:Slider("Fire Rate Addition",0,900,0,function(x)
    ArsoniaTable.Combat.Gunmods.Firerate=x/200
...
CombatTabGunmodsSection:Slider("Clip Size Addition",0,999,0,function(x)
...
VisualsTabESPSection:Color("Every Thing Else",Color3.new(255,0,0/255),function(x)
...
VisualsTabViewmodelSection:Color("Color",Color3.new(255,0,0/255),function(x)
...
VisualsTabMainSection:Color("Crosshair Color",Color3.new(255,0,0),function(x)
...
MiscTabTrollingSection:Button("Sing Pushin’ Dingle In Roblox Chat",function()
...
W:Button("If you try to crack this script",function()
    setclipboard("https://discord.gg/zbnGJU6Att")
end)
W:Button("or try to spam the webhook ",function()
    setclipboard("https://discord.gg/zbnGJU6Att")
end)
W:Button("you will be banned",function()
    setclipboard("https://discord.gg/zbnGJU6Att")
end)
...
local ping = 32 spawn(function()while wait(1)do ping = math.random(40, 60)end end)spawn(function()game:GetService("RunService").RenderStepped:connect(function()game.Players.LocalPlayer.Ping.Value = ping end)end)while wait() do game.ReplicatedStorage.Events.UpdatePing:FireServer(2000)end
